                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form" class="form-edit-add"
                        ...
                        <a href={{ URL::previous() }}><button type="button"
                                class="btn btn-secondary save">Cancelar</button></a>
                    </div>
                </form>
...
<script>
    ...
    $('.save').on('click', function(tag) {
        ...
        if (formData.responsable != null && table == 'pqrsd') {
            $.ajax({
                url: url,
                type: 'POST',
                dataType: 'json',
                ...
                success: function(result) {
                    toastr.success("Email enviado al responsable");
                    /* window.open(result.files[0], '_blank'); */
                },
