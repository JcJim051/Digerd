                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <div class="form-group  col-md-12 ">
                            <label class="control-label" for="name">Tipo de ayuda</label>
                           <select class="select2" name="tipoayuda">
                           @foreach($tiposayuda as $tipoayuda)
                           <option value="{{$tipoayuda->id_tipo_ayuda}}">{{$tipoayuda->descripcion}} [{{$tipoayuda->disponible()}}]
 </option>
                           @endforeach
                           </select>
                        </div>
                        <div class="form-group  col-md-12 ">
                           ...
                           <input type="number" min="0"  class="form-control" id="cantidad" name="cantidad" placeholder="Cantidad" value="1">
                        <input type="hidden" name="idinventario" value="{{$dataTypeContent->id_inventario_salida}}">
                        </div>
                        @csrf
