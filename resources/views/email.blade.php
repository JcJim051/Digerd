                    ...
                    <tr>
                        <td class="wrapper"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; display:grid">
                                        <p
                                            style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                            Hola {{$name}},</p>
                                        <div style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                            Tienes actividades nuevas o actividades por vencer!
                                        </div>
                                        <br>
                                                            ...
                                                            <tbody>
                                                                <a>
                                                                    <td
                                                                        ...
                                                                        <a href="https://sos.meta.gov.co/reportes" target="_blank"
                                                                            style="display: inline-block; color: #ffffff; background-color: #3498db; border: solid 1px #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; border-color: #3498db;">
                                                                            Ingresa a la aplicaci&oacute;n para poder revisar las actividades</a> </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </td>
                        ...
                        <tr>
                            <td class="content-block"
                                ...
                                <span class="apple-link"
                                    style="color: #999999; font-size: 12px; text-align: center;">Gobernaci&oacute;n del Meta 2021</span>
                            </td>
                        </tr>
