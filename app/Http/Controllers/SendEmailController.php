...
class SendEmailController extends Controller
{
    public function responsable(Request $request)
    {
        ...
        $details = [
            ...
            'descripcion' => 'Recuerde que a partir del momento en que se le asignó esta correspondencia, tiene como máximo 10 días para dar una respuesta a la solicitud, atendiendo con el respectivo soporte en la plataforma. ',
